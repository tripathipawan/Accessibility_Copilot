    ...
    <div className="min-h-screen flex bg-white dark:bg-[#060612]">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-700 flex-col justify-between p-12">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 rounded-full opacity-20"
          style={{ background: 'radial-gradient(circle, #fff, transparent 65%)', filter: 'blur(60px)' }}
        />
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/60 text-base leading-relaxed max-w-sm">
            Detect and fix WCAG violations instantly.
            Join developers shipping accessible code.
          </p>
        ...
        <div className="relative z-10 bg-white/10 backdrop-blur rounded-2xl p-5">
          ...
          <div className="flex items-center gap-3 mt-3">
            <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center text-white text-xs font-bold">RS</div>
            <div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center min-h-screen p-6 sm:p-8 bg-white dark:bg-[#060612]">
        ...
        <div className="w-full max-w-md mb-8 lg:hidden">
          <Link to="/" className="flex items-center gap-2 mb-6">
            ...
            <span className="font-bold text-lg text-gray-900 dark:text-white">AccessCopilot</span>
          </Link>
          ...
          <div className="grid grid-cols-2 gap-2 mb-6">
            {[
              ...
              <div key={i} className="flex items-center gap-2 bg-indigo-50 dark:bg-indigo-950/30 rounded-xl px-3 py-2">
